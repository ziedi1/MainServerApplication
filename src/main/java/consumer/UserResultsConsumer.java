 ...
 * @author ziedi
 */
public class UserResultsConsumer implements Runnable{
    
    static void runConsumer() throws Exception {
        Consumer<String, String> consumer = ConsumerCreator.createConsumer(IKafkaConstants.USER_RESULT_TOPIC_NAME);
        while (true) {
